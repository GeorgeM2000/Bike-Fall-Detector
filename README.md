...
<h3>Στόχος</h3>
Ο στόχος της εφαρμογής είναι να ανιχνεύει ατυχήματα και πτώσεις μηχανής η ποδηλάτου και να ειδοποιήσει επιλεγμένες απο τον χρήστη επαφές μέσω μηνυμάτων SMS στα οποία θα περιλαμβάνονται πληροφορίες τοποθεσίας. Όλα αυτά θα γίνονται σε ζωντανό χρόνο κρατώντας την κατανάλωση ενέργειας σε πολύ χαμηλά επίπεδα.
